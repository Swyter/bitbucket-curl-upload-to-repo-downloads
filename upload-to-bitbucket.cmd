...
:start
	...
	curl -k -c cookies.txt -b cookies.txt --referer "https://bitbucket.org/%pge%" -L --form csrfmiddlewaretoken=%csrf% --form token= --form file=@"%fil%" https://bitbucket.org/%pge% --trace-ascii C:\Users\Aaron\Desktop\curl_trace.txt
